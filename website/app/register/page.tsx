    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-slate-900 dark:text-slate-100 mb-2">Create Account</h1>
          <p className="text-slate-600 dark:text-slate-400">Join Harness Cart and start ordering today</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-large p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="register-company" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
